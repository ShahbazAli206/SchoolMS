...
const StaffHomeStack = () => (
  <Stack.Navigator screenOptions={{headerShown: false}}>
    ...
    <Stack.Screen name="StaffComplaintsList"   component={StaffComplaintsScreen} />
...
const ComplaintsStack = () => (
  <Stack.Navigator screenOptions={{headerShown: false}}>
    <Stack.Screen name="StaffComplaintsMain"   component={StaffComplaintsScreen} />
  </Stack.Navigator>
);
...
const StaffNavigator = () => (
  <Tab.Navigator screenOptions={{headerShown: false}} tabBar={p => <CustomTabBar {...p} />}>
    <Tab.Screen name="Home"       component={StaffHomeStack} />
